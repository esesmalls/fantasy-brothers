...
try {
    ...
    Copy-Item -LiteralPath 'art/production/audio-20260923/README.md' -Destination 'builds/windows/AUDIO-SOURCES.md'
    Compress-Archive -Path 'builds/windows/*' -DestinationPath 'builds/FantasyBrothers-0.1.6.1-windows.zip' -Force
    Get-FileHash -Algorithm SHA256 -LiteralPath 'builds/windows/FantasyBrothers.exe', 'builds/FantasyBrothers-0.1.6.1-windows.zip'
