...
try {
    ...
    Compress-Archive -Path 'builds/windows/*' -DestinationPath 'builds/FantasyBrothers-0.1.5.1-windows.zip' -Force
    Get-FileHash -Algorithm SHA256 -LiteralPath 'builds/windows/FantasyBrothers.exe', 'builds/FantasyBrothers-0.1.5.1-windows.zip'
