...
try {
    foreach ($test in @('test_battle', 'test_campaign', 'test_save', 'test_flow', 'test_inspection', 'test_world', 'test_equipment', 'test_character_layers', 'test_characters', 'test_progression_regression')) {
