...
static func sample(weapon: String, progress: float, outcome: String = "hit") -> Dictionary:
	...
	var frames: Array
	if weapon == "spear":
		frames = [[0.0,20.0,-19.0,0.52],[0.25,14.0,-18.0,0.58],
			[0.42,35.0,-31.0,PI/2],[0.53,35.0,-31.0,PI/2],
			[0.64,31.0,-31.0,PI/2],[1.0,20.0,-19.0,0.52]]
	elif weapon == "bow":
		frames = [[0.0,40.0,-31.0,0.0],[0.42,37.0,-31.0,-0.055],
			[0.49,42.0,-31.0,0.035],[0.60,39.0,-31.0,-0.015],
			[1.0,40.0,-31.0,0.0]]
	else:
