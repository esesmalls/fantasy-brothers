...
本轮已有可玩的 Windows 版本：双击根目录 `Play.cmd`，或解压 `builds/FantasyBrothers-0.1.0-windows.zip` 后运行 `FantasyBrothers.exe`。建议从自由佣兵团、种子 `1709` 开始。完整玩法与边界见 [试玩说明](docs/PLAYTEST.md)。
